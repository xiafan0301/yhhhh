    ...
    <el-table style="width: 100%" :data='departmentList' class='event-table'>
      ...
      <el-table-column label="操作" align='center'>
        <template slot-scope="scope">
          <el-button type='text' style='color:#0785FD;font-size:14px;border-radius:15px;border:1px solid;padding:5px 10px' @click='editDepart(scope)'>编辑</el-button>
          ...
          <el-button type='text' style='color:#0785FD;font-size:14px;border-radius:15px;border:1px solid;padding:5px 10px' @click='deleteDepart(scope)'>删除</el-button>
        </template>
      </el-table-column>
    </el-table>
