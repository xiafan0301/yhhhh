  ...
  <div class="bg-release">
    <div style=" margin-bottom: 20px;">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item :to="{name: 'link-simulate-notice'}" v-if="this.$route.query.status === 'atgment'">模拟发布公告</el-breadcrumb-item>
        ...
        this.$refs[val].validate((valid) => {
          if (valid) {
            ...
            this.axios.post('A2/messageService', params)
              .then((res) => {
                if (res) {
                  this.$router.push({name: 'link-simulate-notice'})
                  this.addPageLoading = false
