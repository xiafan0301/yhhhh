<template>
  <div class="um-main">
    <el-breadcrumb class="breadcrumb" separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/main/organization' }">组织架构</el-breadcrumb-item>
  ...
  methods: {
    ...
    getList () {
      let params = Object.assign({}, this.filter, this.pagination, {
        ...
        'where.proKey': this.$store.state.proKey
      })
    ...
    onAdminNumber () {
      ...
      this.axios.get('S2/auth/authServices/users?where.proKey=' + this.$store.state.proKey)
        .then(res => {
          if (res) {
