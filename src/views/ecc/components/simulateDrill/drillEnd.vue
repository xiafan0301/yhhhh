<template>
  <div class='drill-end'>
    <div class='drill-end-header'>
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item>模拟演练</el-breadcrumb-item>
        <el-breadcrumb-item>模拟调度指挥</el-breadcrumb-item>
        <el-breadcrumb-item><span style='color: #0785FD'>演练结束</span></el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class='drill-end-body'>
      <p class="title">评估演练情况</p>
      <el-form class='drill-end-form' :model='endForm' ref='endForm' :rules='rules' inline-message >
        <el-form-item label="" label-width='100px' prop='eventSummary' class="drill-summary">
          <el-input type='textarea' v-model='endForm.eventSummary' style="width: 500px;" rows='9' placeholder='评估说明' @input="calNumber(endForm.eventSummary)"></el-input>
    ...
    <div class='operation-btn-event-end'>
      ...
      <el-button style='background: #0785FD;color:#fff' :loading="isEndLoading" @click="endDrill('endForm')">确定</el-button>
    </div>
     <el-dialog
      title="操作提示"
