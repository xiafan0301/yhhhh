<template>
  <div class="vis-bg-plate">
    ...
    <div class="bg-plate-sf">
      ...
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == '1bfa2f78-2174-4e9d-8f2f-58264a00ce83'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/1bfa2f78-2174-4e9d-8f2f-58264a00ce83'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == '9487e07e-6b2f-49c6-b464-2216a680cc3e'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/9487e07e-6b2f-49c6-b464-2216a680cc3e'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == '61894e2c-7738-41af-b797-b8d735a44428'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/61894e2c-7738-41af-b797-b8d735a44428'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == 'e5654a00-c642-44f3-a340-2827f51367d6'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/e5654a00-c642-44f3-a340-2827f51367d6'">模版下载</a>
      ...
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == 'dc42b85c-ee98-4895-bfc2-4c472a092170'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/dc42b85c-ee98-4895-bfc2-4c472a092170'">模版下载</a>
      ...
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == 'f90edff9-7f21-48e0-9ce4-472377825dae'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/f90edff9-7f21-48e0-9ce4-472377825dae'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == 'd42795ca-dad6-4531-aed7-eb75f3d3646d'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/d42795ca-dad6-4531-aed7-eb75f3d3646d'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == 'a649c4a2-314e-4490-bfee-ca3b7695057b'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/a649c4a2-314e-4490-bfee-ca3b7695057b'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == 'd633bafc-74d0-4f0d-bea5-927ef2df4192'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/d633bafc-74d0-4f0d-bea5-927ef2df4192'">模版下载</a>
      ...
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == '88ee0a59-19a0-4e42-b4d2-bae59634e110'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/88ee0a59-19a0-4e42-b4d2-bae59634e110'">模版下载</a>
      ...
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == '25c2ec86-a62e-45c2-a3e7-49a121a1f56d'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/25c2ec86-a62e-45c2-a3e7-49a121a1f56d'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == 'ac94e4c6-7e49-45c5-9610-1556245c45cf'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/ac94e4c6-7e49-45c5-9610-1556245c45cf'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == '739fe4f5-49c6-42ca-ba87-76f5300ab5af'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/739fe4f5-49c6-42ca-ba87-76f5300ab5af'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == 'd60e1ff2-e6c0-4393-94c7-28bb9f118cce'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/d60e1ff2-e6c0-4393-94c7-28bb9f118cce'">模版下载</a>
      <a style="color:#0785FD;font-size:14px;" size="mini" class="add-plate-btns" v-if="this.searchForm.dataTypeId  == '4fce5edb-7092-4455-971b-6f8526d6a827'" :href="$store.state.fileUploadUrl + '/mapServices/template/download/4fce5edb-7092-4455-971b-6f8526d6a827'">模版下载</a>
