    ...
    <el-table-column
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <i style="display: inline-block; width:1px;height:11px;background:rgba(221,221,221,1);margin: 0 2px 0 2px"></i>
          <el-button type="text"   @click="schu(scope)">删除</el-button>
