        ...
        <div class="ecl2-cr-list" style="margin-top: 40px;">
          ...
          <table class="plate-table" style="width: 100%;">
            ...
            <tbody>
              <tr>
                <td>1212</td>
                <td><input type="text" v-model="name" placeholder="请填浮层并列项名称"></td>
                <td><input type="text" v-model="name" placeholder="请填单位"></td>
              </tr>
            </tbody>
          </table>
          <div class="checkbox">
            <template>
              <el-checkbox v-model="checked">添加浮层子项合计项（各子项单位、浮层并列项单位一致的情况下，才可添加）</el-checkbox>
            </template>
          </div>
        </div>
        <div class="ecl2-cr-list" style="margin-top: 40px;">
