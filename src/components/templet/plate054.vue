  ...
  <div class="vis-temp-main">
    ...
    <div class="vis-cou-content">
      ...
      <div class="vis-cou-ctt-c" style="padding-top: 2rem;">
        <div class="vis-cou-ctt-cc" id="vis_temp_054"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    laodVisCou6 () {
      ...
      let temp054 = document.getElementById('vis_temp_054');
      const chart = new G2.Chart({
        container: 'vis_temp_054',
        forceFit: true,
        padding: [ 1 * intRem, 0, 2 * intRem, 4 * intRem ],
        width: G2.DomUtil.getWidth(temp054),
        height: G2.DomUtil.getHeight(temp054)
      });
      chart.source(data, {
        count: {
          min: 0,
