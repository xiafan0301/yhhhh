...
<template>
  <div class="vis-temp-main" style="position: relative;">
    ...
    <div class="vis-cou-content" style="overflow: hidden;position: relative;">
      <div style="position: absolute; top: -1rem; left: 0; width: 100%; height: 2rem;">
      ...
      <div style="padding-top: 2rem; height: 100%;overflow: hidden; position: relative;">
  ...
  methods: {
    theRightReport (data) {
      ...
      const chart = new G2.Chart({
        ...
        forceFit: true,
        padding: [ 0 * intRem, 1 * intRem, 3 * intRem, 5 * intRem ],
    ...
    theLeftReport (data) {
      ...
      const chart = new G2.Chart({
        ...
        forceFit: true,
        padding: [ 0 * intRem, intRem, 3 * intRem, 1 * intRem ],
