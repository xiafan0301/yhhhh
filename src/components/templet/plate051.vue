...
<template>
  <div class="vis-temp-main" style="position: relative;">
    ...
    <div class="vis-cou-content" id="vis_temp_032" style="">
      <span style="position: absolute; left: 1rem; top: 0.5rem;color: #ddd;">单位(亿元)</span>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  mounted () {
    let data2 = [
      { name: '第一产业', '2012': 32, '2013': 36, '2014': 39, '2015': 42, '2016': 53, '2017': 55 },
      { name: '第二产业', '2012': 33, '2013': 34, '2014': 38, '2015': 44, '2016': 51, '2017': 56 },
      { name: '第三产业', '2012': 33, '2013': 34, '2014': 38, '2015': 44, '2016': 51, '2017': 56 }
    ];
  ...
  methods: {
    theReport (data) {
      ...
      chart.interval()
        ...
        .shape('cylinder')
        // .shape('smooth')
        .color('name', ['#7B87FC', '#02CCE6', '#1774F2'])
        .adjust([{
          type: 'dodge',
          marginRatio: 1 / 32
        }]);
